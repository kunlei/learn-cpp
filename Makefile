...
SRC      :=                      \
	...
	$(wildcard src/cost/*.cpp) \
	$(wildcard src/common/*.cpp) \
	$(wildcard src/constraint/*.cpp ) \
	$(wildcard src/cprouting/*.cpp) \
	$(wildcard src/dcrouting/*.cpp) \
	$(wildcard src/loadpicking/*.cpp) \
	$(wildcard src/config/*.cpp) \
	$(wildcard src/input/*.cpp) \
	$(wildcard test/*.cpp) \
	$(wildcard test/input/*.cpp) \
	$(wildcard test/flow/*.cpp) \
	$(wildcard *.cpp) \
